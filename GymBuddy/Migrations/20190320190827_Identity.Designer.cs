...
namespace GymBuddy.Migrations
{
    ...
    [Migration("20190320190827_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymBuddy.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, OrderDate = new DateTime(2019, 3, 20, 19, 8, 26, 872, DateTimeKind.Utc), OrderNumber = "12345" }
                    );
                });
            ...
            modelBuilder.Entity("GymBuddy.Data.Entities.UserStore", b =>
                {
            ...
            modelBuilder.Entity("GymBuddy.Data.Entities.Order", b =>
                {
                    b.HasOne("GymBuddy.Data.Entities.UserStore", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GymBuddy.Data.Entities.UserStore")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
